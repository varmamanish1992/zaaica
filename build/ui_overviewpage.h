...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setText(QStringLiteral("0 ZIC"));
        ...
        labelStake->setText(QStringLiteral("0 ZIC"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 ZIC"));
        ...
        labelImmature->setText(QStringLiteral("0 ZIC"));
